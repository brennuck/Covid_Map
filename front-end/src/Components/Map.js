		...
		return (
			<ReactMapGL
				...
				mapboxApiAccessToken={
					"pk.eyJ1IjoiYnJlbm51Y2siLCJhIjoiY2tlMXlkZWozMDN6dzMxbHE5NHJlYzlkbCJ9.fBfI2mwJEhLuvIYxIf3Nvg"
				}
			>
				{this.state.map_data.map((country, index) => {
